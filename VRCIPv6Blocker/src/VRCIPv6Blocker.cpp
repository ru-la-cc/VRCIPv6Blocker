...
void VRCIPv6BlockerApp::VRCExecuter() {
	...
	if(m_VRCProcess->UserExecute(m_Config.GetConfig().strExecutePath.c_str()) == -1) {
		::SetDlgItemTextW(m_hWnd, IDC_STATIC_STATUS, L"VRChat未起動");
